...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val wyaButton : Button = findViewById(R.id.wyaButton)
        ...
        var exampleUpgrades : Map<String, Int> = mapOf(UpgradeType.TESTUDO_TAPPER.name to 3,
            UpgradeType.HERVE_HAMMER.name to 0)
        ...
        wyaButton.setOnClickListener{
            val intent = Intent(this, WyaActivity::class.java)
